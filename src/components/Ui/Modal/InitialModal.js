      ...
      <div>
        ...
        >
          ...
          <Modal.Body className="initial-modal__body">
            ...
            <div>
            <p>
              This is a DEMO task manager application built with <strong>React JS</strong>. 
              You can create new tasks, mark them as completed or favorite.
            </p>
          ...
          <Modal.Footer>
            <Button
              style={{ backgroundColor: "#f2d492", border: "none",  color: "#23272a"}}
